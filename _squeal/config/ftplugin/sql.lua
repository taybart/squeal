...
-- Highlight the character under cursor with a subtle color
local function highlight()
  ...
  -- Define a subtle highlight group if not already defined
  vim.api.nvim_set_hl(0, 'SquealSubtleCursor', {
    bg = '#3a3a3a',      -- Dark gray background (adjust for your theme)
    fg = 'none',         -- Keep foreground unchanged
    underline = false,
    bold = false,
  })
